...
#if !defined(PRECISION_TOUCHPAD_IN_CAPACITY)
#    define PRECISION_TOUCHPAD_IN_CAPACITY USB_DEFAULT_BUFFER_CAPACITY
#endif

#if !defined(PRECISION_TOUCHPAD_OUT_CAPACITY)
#    define PRECISION_TOUCHPAD_OUT_CAPACITY USB_DEFAULT_BUFFER_CAPACITY
#endif
...
#   if defined(PRECISION_TOUCHPAD_ENABLE)
    USB_ENDPOINT_IN_PRECISION_TOUCHPAD = USB_ENDPOINT_IN_SHARED,
#   endif
#endif
