...
#if defined(PRECISION_TOUCHPAD_ENABLE)
#    if defined(USB_ENDPOINTS_ARE_REORDERABLE)
    [USB_ENDPOINT_IN_PRECISION_TOUCHPAD] = QMK_USB_ENDPOINT_IN_SHARED(USB_EP_MODE_TYPE_INTR, PRECISION_TOUCHPAD_EPSIZE, PRECISION_TOUCHPAD_IN_EPNUM, PRECISION_TOUCHPAD_IN_CAPACITY, NULL, NULL),
#    else
    [USB_ENDPOINT_IN_PRECISION_TOUCHPAD] = QMK_USB_ENDPOINT_IN(USB_EP_MODE_TYPE_INTR, PRECISION_TOUCHPAD_EPSIZE, PRECISION_TOUCHPAD_IN_EPNUM, PRECISION_TOUCHPAD_IN_CAPACITY, NULL, NULL),
#    endif
#endif
};
