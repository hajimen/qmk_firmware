...
// clang-format off
    ...
    QMK_USB_REPORT_STORAGE(
        ...
        QMK_USB_REPORT_STROAGE_ENTRY(REPORT_ID_PRECISION_TOUCHPAD, sizeof(report_precision_touchpad_t)),
        QMK_USB_REPORT_STROAGE_ENTRY(REPORT_ID_PRECISION_TOUCHPAD_CAPABILITY, sizeof(report_precision_touchpad_device_capability_t)),
        QMK_USB_REPORT_STROAGE_ENTRY(REPORT_ID_PRECISION_TOUCHPAD_CERTIFICATION, sizeof(report_precision_touchpad_device_certification_status_t)),
        QMK_USB_REPORT_STROAGE_ENTRY(REPORT_ID_PRECISION_TOUCHPAD_INPUT_MODE, sizeof(report_precision_touchpad_device_input_mode_t)),
        QMK_USB_REPORT_STROAGE_ENTRY(REPORT_ID_PRECISION_TOUCHPAD_SELECTIVE_REPORTING, sizeof(report_precision_touchpad_device_selective_reporting_t)),
#endif
        )
    ),
#endif
...
#if defined(PRECISION_TOUCHPAD_ENABLE)
#    if defined(USB_ENDPOINTS_ARE_REORDERABLE)
    [USB_ENDPOINT_IN_PRECISION_TOUCHPAD] = QMK_USB_ENDPOINT_IN_SHARED(USB_EP_MODE_TYPE_INTR, PRECISION_TOUCHPAD_EPSIZE, PRECISION_TOUCHPAD_IN_EPNUM, PRECISION_TOUCHPAD_IN_CAPACITY, NULL, QMK_USB_REPORT_STORAGE_DEFAULT(PRECISION_TOUCHPAD_EPSIZE)),
#    else
    [USB_ENDPOINT_IN_PRECISION_TOUCHPAD] = QMK_USB_ENDPOINT_IN(USB_EP_MODE_TYPE_INTR, PRECISION_TOUCHPAD_EPSIZE, PRECISION_TOUCHPAD_IN_EPNUM, PRECISION_TOUCHPAD_IN_CAPACITY, NULL, QMK_USB_REPORT_STORAGE_DEFAULT(PRECISION_TOUCHPAD_EPSIZE)),
#    endif
#endif
};
